...
Create a new **embed.js** file and add the following code to try out some basic CRUD
...
Add to **embed.js** the following function which uses the **insertMany**
